...
//                                         size="sm"
//                                         color="default"
//                                         classNames={{wrapper: "bg-zinc-800 gorup-data-[selected=true]:bg-white group-data-[selected=true]:text-black", thumb: "bg-zinc-400 group-data-[selected=true]:bg-black"}}
//                                     >
...
//     );
// }
// // (3)en then (start: 57_6) 
// // ---------------------End:57_5-(1) to () --------------------------------
// // -----------------------------Start: 57_6---------------------------------------
// // (1)check console filluping the form
// "use client";
...
//                                         </Switch.Content>
//                                     </Switch>
//                                     {/* (3)en then (start: 57_7) create hireloop-server commanding mkdir hireloop-server and etc*/}
//                                 </div>
...
//             e.target.reset();
//             setIsRemote(false);
//             // (7) then (start: 57_9) create lib/api/jobs.js
//             redirect("/dashboard/recruiter/jobs");
//         }
//         // (6)en then check to submit job table
//     };
...
// } 
// // (10)en
// (11) copy (10) to creating PostJobForm.jsx page in new folder and commit (10)
...
const PostJobPage = async () => {
    ...
    return (
        <div>
            {/* (14) then go to api/companies */}
            {/* <PostJobForm></PostJobForm> */}
            {/* (18) then go to PostJobForm.jsx file */}
