...
//             // Replace with your real IMGBB API key environmental variable injection
//             // const IMGBB_API_KEY = 'YOUR_IMGBB_API_KEY';
//             // (3) then update company profile using one picture. and check in console and then (start: 58_3) go to server 
//             const IMGBB_API_KEY = process.env.NEXT_PUBLIC_IMAGE_UPLOAD_API;
//             const response = await fetch(`https://api.imgbb.com/1/upload?key=${IMGBB_API_KEY}`, {
//                 method: 'POST',
//                 body: formData
...
//             // recruiterId: recruiter.id // Associate company with the current recruiter
//         });
//         // (1)st then create account to imgbb.com and go to .env file
...
//             toast.success("Company profile created successfully!");
//         }
// // (10)en check Company Profile and go to lib/actions/companies.jsx
...
// // }
// // (3)en
// // (4) copy (3) to creating file CompanyProfile.jsx in company folder and commit (3) here
...
//     // (9)en then check in console
//     return (
//         <div>
//             {/* (7) then create core/session.js*/}
//             {/* <CompanyProfile></CompanyProfile> */}
//             {/* (12) then go to CompanyProfile.jsx*/}
