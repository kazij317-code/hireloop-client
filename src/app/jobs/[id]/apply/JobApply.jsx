...
// // (14)en then go to apply/page.jsx
// // ---------------------End:59_1-(1) to () --------------------------------
// // -----------------------------Start: 59_3---------------------------------------
// // (3)st
// // import React from 'react';
...
// // export default JobApply;
// // (3)en
// // (4)st commit (3) and import from AI
// 'use client';
...
//             jobId: job?._id,
//             // jobTitle: job?.title,
//             // (4-2) then check and then go to server
//             jobTitle: job?.jobTitle,
//             // (10) then check to apply and then (start:59.4) go to server
