...
// //     // (9)en then go to server
// //     return (
// //         <div>
// //             {/* hi from job details page */}
// //             {/* (7) then  go to lib/api/jobs.js*/}
// //             hi from job details page {id}
// //         </div>
// //     );
// // };
...
// export default Page;
// // (11)en then (start: 59_1) create jobs/[id]/apply/page.jsx
