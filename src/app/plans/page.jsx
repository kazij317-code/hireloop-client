...
// // (3)en then (start:59.6) then go to Navbar.jsx
// // ---------------------End:59_5-(1) to () --------------------------------
// // -----------------------------Start: 59_7---------------------------------------
...
//                                     </section>
//                                 </form>
//                                 {/* (4)en then go to plans/success/page.jsx file*/}
//                             </div>
//                         </div>
//                     ))}
//                 </div>
...
const PricingPage = () => {
    ...
    const seekerPlans = [
        ...
        {
            name: 'Premium',
            // (3) then go to lib/stripe.js file
            id: 'seeker_premium',
            price: '$39',
            period: '/month',
            description: 'Uncapped potential and priority visibility tools tailored for elite competitive talent placement.',
    ...
    const recruiterPlans = [
        ...
        {
            name: 'Enterprise',
            // (7) then go to lib/stripe.js file
            id: 'recruiter_enterprise',
            price: '$149',
            period: '/month',
            description: 'High performance structural operations for organizations with continuous large-scale talent acquisition.',
                    ...
                    {activePlans.map((plan, idx) => (
                        ...
                        >
                            ...
                            <div className="mt-8">
                                ...
                                <form action="/api/checkout_sessions" method="POST">
                                {/* (10) then go to /api/checkout_sessions/route.js file */}
                                    <input type="hidden" name="plan_id" value={plan.id} />
                                    <section>
                                        <button type="submit" role="link"
                                            className={`block w-full text-center text-xs font-semibold px-4 py-3 rounded-xl transition duration-200 ${plan.popular
